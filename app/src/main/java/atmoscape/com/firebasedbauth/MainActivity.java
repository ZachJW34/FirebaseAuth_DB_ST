...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signinEP = (Button) findViewById(R.id.signinEP);
        ...
        signinEP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                signInWithEP();
            }
    ...
    private void signInWithEP(){
        EditText emailText = (EditText) findViewById(R.id.emailET) ;
